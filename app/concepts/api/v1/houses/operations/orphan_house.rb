...
module Api
  module V1
    module Houses
      module Operations
        class OrphanHouse < ApplicationOperation
          ...
          def validate_schema
            @ctx['contract.default'] = Api::V1::Houses::Contracts::OrphanHouse.kall(@params)
          ...
          def list
            @ctx[:data] = Api::V1::Houses::Queries::OrphanHouse.call(@ctx['contract.default']['filter'], @ctx[:sort])
