...
module Api::V1::Users::Accounts::Operations
  class Confirm < ApplicationOperation
    ...
    def decode_token
      begin
        jwt_adapter.decode(@ctx['contract.default'].model[:token]).first['sub']
        ...
        @ctx['contract.default'].errors.add(:base, I18n.t('errors.token.expired'))
