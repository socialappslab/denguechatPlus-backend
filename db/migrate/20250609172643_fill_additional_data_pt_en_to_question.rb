class FillAdditionalDataPtEnToQuestion < ActiveRecord::Migration[7.1]
  def up
    ...
    question.additional_data_es = { image: url, title: 'Visitemos la casa',
                                    description: 'Lleguemos a la casa con mucho respeto.' }
    question.additional_data_en = { image: url, title: "Let's visit the house",
                                    description: "Let's arrive at the house with great respect." }
    question.additional_data_pt = { image: url, title: 'Vamos visitar a casa',
                                    description: 'Vamos chegar à casa com muito respeito.' }
    question.save!
