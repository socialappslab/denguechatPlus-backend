...
class AddTarikiStatusTimeWindowAppConfigParam < ActiveRecord::Migration[7.1]
  ...
  def up
    MigrationAppConfigParam.find_or_create_by!(name: 'consecutive_green_statuses_for_tariki_house') do |param|
      param.description = 'Number of consecutive green visit days required for a house to reach Tariki status'
      param.param_source = 'TarikiPoint'
