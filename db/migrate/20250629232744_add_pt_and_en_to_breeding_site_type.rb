class AddPtAndEnToBreedingSiteType < ActiveRecord::Migration[7.1]
  def up
    ...
    translations = {
      ...
      "Bidones o cilindros (metal, plástico)" => { en: "Barrels or cylinders (metal, plastic)", pt: "Tambores ou cilindros (metal, plástico)" },
      ...
      "Criaderos, bebederos o acuarios" => { en: "Breeding sites, drinkers or aquariums", pt: "Criadouros, bebedouros ou aquários" }
    }
